...
def cy_td_ode_rhs(
    ...
    spmvpy(&data0[0], &idx0[0], &ptr0[0], &vec[0], (0 if (t > 442.033137) else _td_array_0[int(round(3500 * (t/442.033137)))]), &out[0], num_rows)
    spmvpy(&data1[0], &idx1[0], &ptr1[0], &vec[0], (0 if (t > 442.033137) else _td_array_1[int(round(3500 * (t/442.033137)))]), &out[0], num_rows)
